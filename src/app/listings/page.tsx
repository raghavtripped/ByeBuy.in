          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-8">
            ...
            <div className="w-full flex justify-center mb-8">
              <button
                ...
                className="group relative z-10 w-full max-w-sm sm:max-w-md lg:max-w-lg"
              >
                {/* Overlay gradient now ignores pointer events */}
                ...
                <div className="relative bg-white/90 dark:bg-bye-dark-bg-secondary/90 backdrop-blur-sm border border-gray-200 dark:border-bye-dark-border-primary rounded-2xl shadow-lg p-4 transition-all duration-300 group-hover:shadow-xl">
