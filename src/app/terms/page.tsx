    ...
    <div className="min-h-screen bg-white dark:bg-bye-dark-bg-primary">
      <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 py-10">
        ...
        <main className="prose dark:prose-invert max-w-none text-gray-700 dark:text-bye-dark-text-primary leading-relaxed">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-bye-dark-text-primary">1. Acceptance of Terms</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-bye-dark-text-primary">2. Changes to Terms</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-bye-dark-text-primary">3. User Accounts</h2>
          <ul>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-bye-dark-text-primary">4. The Service as a Marketplace</h2>
          <ul>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-bye-dark-text-primary">5. Listing and Bidding Rules</h2>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-bye-dark-text-primary">6. Prohibited Conduct</h2>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-bye-dark-text-primary">7. Fees</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-bye-dark-text-primary">8. Content Ownership and License</h2>
          <ul>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-bye-dark-text-primary">9. Disclaimers</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-bye-dark-text-primary">10. Limitation of Liability</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-bye-dark-text-primary">11. Indemnification</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-bye-dark-text-primary">12. Governing Law and Dispute Resolution</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-bye-dark-text-primary">13. General Provisions</h2>
          <ul>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-bye-dark-text-primary">14. Contact Information</h2>
          <p>
            If you have any questions about these Terms, please contact us at{' '}
            <a href={`mailto:${contactEmail}`} className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 hover:underline">
              {contactEmail}
            </a>.
          </p>
        </main>
