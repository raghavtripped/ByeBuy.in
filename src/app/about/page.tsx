...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-bye-dark-bg-primary">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-bye-dark-text-primary mb-8">
          About ByeBuy
        </h1>

        <div className="space-y-8 text-gray-600 dark:text-bye-dark-text-secondary">
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 dark:text-bye-dark-text-primary mb-4">
              Our Mission
            </h2>
          ...
          <section>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-bye-dark-bg-secondary p-6 rounded-xl border border-gray-200 dark:border-bye-dark-border-primary">
