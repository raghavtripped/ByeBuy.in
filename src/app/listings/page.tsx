  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-bye-dark-bg-primary dark:via-bye-dark-bg-primary dark:to-bye-dark-bg-primary">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12"> {/* Added z-10 */}
          {/* ------------------------- Hero Header ------------------------ */}
          ...
          <div className="flex justify-center mb-8 relative z-10"> {/* Added relative z-10 */}
            <button
              onClick={() => setIsCategoryModalOpen(true)}
              // Removed 'relative', Added z-20
