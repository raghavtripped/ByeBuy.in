...
export default function NotificationsPage() {
  ...
  if (!user) {
    return (
      <div className="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8 text-center">
        <h1 className="text-2xl sm:text-3xl font-bold mb-4 text-gray-900 dark:text-bye-dark-text-primary">
          Notifications
        </h1>
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
      <h1 className="text-2xl sm:text-3xl font-bold mb-6 text-gray-900 dark:text-bye-dark-text-primary">
        Notifications
      </h1>

      {notifications.length === 0 ? (
        <div className="text-center py-12 bg-white dark:bg-bye-dark-bg-secondary rounded-lg border border-gray-200 dark:border-bye-dark-border-primary">
            ...
            <div
              ...
              className={`p-4 rounded-lg border ${
                notification.read
                  ...
                  : 'bg-blue-50 dark:bg-blue-900/25 border-blue-200 dark:border-blue-700/50'
              }`}
              onClick={() => {
